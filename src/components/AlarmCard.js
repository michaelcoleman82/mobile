...
const TonePicker = ({changeView, tones, ...props})=>{
  const s = StyleSheet.create({
    container:{
      margin:15,
      flex:1,
  ...
  return <View style={s.container}>
    ...
    <View style={{height:120}}>
      ...
      <ScrollView style={s.scroll}>
        ...
        <VertRadioGroup style={{alignSelf:'center'}} tones={tones} {...props}   />
      </ScrollView>
    </View>
  </View>
}
...
export default class extends Component{
  ...
  views =()=>{
    ...
    return [
      ...
      <TonePicker tones={tones}  {...tonePicker} changeView={this.changeView}/>,
    ]
  }
